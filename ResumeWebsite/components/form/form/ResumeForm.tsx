...
import { ResumeData, ExtraSection, ExtraSectionPosition } from "@/ResumeWebsite/types/resume";
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="position-sidebar">Sidebar(Works only when sidebar exists)</Label>
                      </div>
