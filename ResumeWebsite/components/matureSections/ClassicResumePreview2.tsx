...
import MainContent from '../rawSections/sections_2/MainContent';
import SideContent from '../rawSections/sections_2/SideContent';
...
const ClassicResumePreview: React.FC<ClassicResumePreviewProps> = ({
  ...
  return <div id="resume-preview" className="w-[210mm] h-[297mm] bg-white mx-auto  overflow-hidden flex">
